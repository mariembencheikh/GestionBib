...
<table class="table table-striped">
	...
	<tr>
			...
			<td>
              	<a href="BibliothéqueController?action=supprimerAut&id=${a.id}" onclick="return confirm('Are you sure you want to delete this item?');">
             		<span class="fa fa-trash-alt btn btn-danger"></span>
	             </a>
	             <a href="BibliothéqueController?action=modifierAut&id=${a.id}">
...
<br>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="nom" name="nom" value="${auteur.nom}" placeholder="Nom">
    </div>
    <div class="form-group col-md-6">
      <label for="nom">Prénom</label>
      <input type="text" class="form-control" id="prenom" name="prenom" value="${auteur.prenom}" placeholder="Prénom">
    </div>
  </div>
  <button type="submit" class="btn btn-success" name="action" value="saveAut">
		 ...
		 <c:if test="${auteur.id==null}">
		  ...
		  <c:if test="${auteur.id!=null}">
             ...
             <input type="hidden" class="form-control"  name="id" value="${auteur.id}">
