...
<table class="table table-striped">
	...
	<tr>
			...
			<c:if test="${role == 'admin'}">
			<td>
              	<a href="BibliothéqueController?action=supprimer&id=${e.idEditeur}" onclick="return confirm('Are you sure you want to delete this item?');">
             		<span class="fa fa-trash-alt btn btn-danger"></span>
	             </a>
	             <a href="BibliothéqueController?action=modifier&id=${e.idEditeur}">
