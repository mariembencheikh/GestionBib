...
<div class="alert alert-danger alert-dismissible" runat ="server" id="modalEditError" visible ="false">
  ...
  <strong>L'auteur a été bien ajouté</strong> <div id="Div2" runat="server" ></div>
</div>
...
<table class="table table-striped">
	...
	<tr>
			...
			<c:if test="${role == 'admin'}">
			<td>
              	<a href="BibliothéqueController?action=supprimer&id=${a.id}" onclick="return confirm('Are you sure you want to delete this item?');">
             		<span class="fa fa-trash-alt btn btn-danger"></span>
	             </a>
	             <a href="BibliothéqueController?action=modifier&id=${a.id}">
